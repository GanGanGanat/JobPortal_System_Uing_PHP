...
<main class="d-flex flex-nowrap">
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px; height:870px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="./Education.php" class="nav-link text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#table"/></svg>
          Education
        </a>
      </li>
      <li>
        <a href="./SearchJob.php" class="nav-link text-white">
    ...
    <div class="dropdown">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
        ...
        <strong class="mx-2"><?php echo "<h6>". $_SESSION['JobSeekerName']."</h6>"; ?></strong>
      </a>
