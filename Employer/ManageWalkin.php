        ...
        <div class="flex-fill" style="background-color: #f1f2f3;">
            ...
            <table class="table table-striped table-hover">
                ...
                <?php
                    ...
                    $sql = "select * from walkin_master where CompanyName='".$_SESSION['CompanyName']."'";
                    $result = mysqli_query($conn, $sql) or die("Query Unsuccessful...");
                    $records = mysqli_num_rows($result);
                    while($row = mysqli_fetch_assoc($result)){
                        ?>
                        <tr>
                            <td><?php echo $row['WalkInId']; ?></td>
                            ...
                            <td><a href="DeleteWalkin.php?WalkinId=<?php echo $row['WalkInId'];?>" class="btn btn-danger">Delete</a></td>
                        </tr>                       
                    <?php } ?>                                
            </table>
        </div>
